    ...
    <>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#050816]/95 backdrop-blur-2xl border-t border-white/10 px-6 py-3 pb-safe shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
        <div className="flex justify-between items-center">
          <a href="#home" onClick={(e) => handleNavClick(e, navLinks[0])} className={`flex flex-col items-center gap-1.5 transition-colors ${activeLink === 'Home' ? 'text-primary scale-110' : 'text-white/50 hover:text-white/80'}`}>
            <Home size={22} className={activeLink === 'Home' ? 'fill-primary/20' : ''} />
            <span className="text-[10px] font-semibold tracking-wide">Home</span>
          </a>
          
          <a href="#services" onClick={(e) => handleNavClick(e, navLinks[2])} className={`flex flex-col items-center gap-1.5 transition-colors ${activeLink === 'Services' ? 'text-primary scale-110' : 'text-white/50 hover:text-white/80'}`}>
          ...
          <a href="#portfolio" onClick={(e) => handleNavClick(e, navLinks[4])} className={`flex flex-col items-center gap-1.5 transition-colors ${activeLink === 'Portfolio' ? 'text-primary scale-110' : 'text-white/50 hover:text-white/80'}`}>
          ...
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" stroke="none" className="transition-colors">
