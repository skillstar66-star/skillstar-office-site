...
const Footer = () => {
  const socialIcons = [
    ...
    { name: 'Facebook', href: 'https://www.facebook.com/profile.php?id=61593932083300', svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg> },
    ...
    { name: 'Linkedin', href: 'https://www.linkedin.com/in/skillstar-digital-solutions-458453434/', svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg> },
    { name: 'Twitter / X', href: 'https://x.com/skillstards360', svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4l11.733 16h4.267l-11.733 -16z"/><path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772"/></svg> }
  ];
            ...
            <div className="bg-[#0A0F24]/90 border border-white/10 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4 backdrop-blur-md shadow-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:skillstardigitalsolutions@gmail.com" className="text-xs sm:text-sm font-bold text-white hover:text-[#00C6FF] transition-colors">
