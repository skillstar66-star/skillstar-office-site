            ...
            <div className="flex items-center gap-6 mb-12">
              <div className="flex -space-x-3">
                {avatars.map((avatar, i) => (
                  <img key={i} src={avatar} alt={`SkillStar Digital Solutions Client ${i + 1}`} loading="lazy" className="w-12 h-12 rounded-full border-2 border-[#02040f] object-contain bg-white p-1 relative" style={{ zIndex: 4 - i }} />
                ))}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <img src={currentTest.avatar} alt={`${currentTest.name} - SkillStar Client Review`} loading="lazy" className="w-10 h-10 md:w-12 md:h-12 rounded-full border border-white/20 object-contain bg-white p-1" />
                    <div>
              ...
              <div key={i} className="flex items-center gap-3 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300 cursor-pointer">
                {brand.logo ? (
                  <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center p-1 overflow-hidden shrink-0">
                    <img src={brand.logo} alt={`${brand.name} - Trusted Partner of SkillStar`} loading="lazy" className="w-full h-full object-contain" />
                  </div>
                ) : (
