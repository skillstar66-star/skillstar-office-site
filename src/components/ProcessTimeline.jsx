...
const ProcessTimeline = () => {
  ...
  return (
    <section id="process" className="relative min-h-screen bg-[#02040a] py-20 flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Main Content Grid */}
      <div className="relative z-20 w-full max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-[1.5fr_2fr_1.5fr] gap-8 items-center min-h-[600px] mt-10">
        
        {/* Left: Steps List */}
        <div className="flex flex-col justify-between h-full py-10 relative">
          {/* Vertical Track connecting circles */}
          <div className="absolute left-[19px] top-[100px] bottom-[100px] w-px bg-white/10 -z-10 hidden lg:block"></div>
                  ...
                  <div className={`text-sm lg:text-base font-medium transition-all duration-500 mt-[42px] relative w-full ${isActive ? 'text-white' : 'text-white/40 group-hover:text-white/60'}`}>
                    ...
                    {isActive && (
                      <motion.div 
                        ...
                        className="absolute -bottom-4 left-[20px] w-[150%] lg:w-[280px] h-[40px] pointer-events-none"
        ...
        {/* Center: Glowing Logo (Hidden on mobile) */}
        <div className="hidden lg:flex items-center justify-center relative h-full">
          ...
          <div className="relative w-80 h-80 lg:w-[450px] lg:h-[450px] flex items-center justify-center">
            ...
            <div className="w-full h-full rounded-full flex flex-col items-center justify-center z-10 relative">
              <img src={logoImg} alt="Skillstar Digital Solutions" className="w-72 lg:w-96 object-contain drop-shadow-[0_0_25px_rgba(255,255,255,0.6)]" />
            </div>

            {/* Lightning AI nerve connection to right card */}
            <div className="absolute left-[70%] top-1/2 -translate-y-1/2 w-[60vw] lg:w-[500px] h-[120px] -z-10 hidden lg:block opacity-100 pointer-events-none">
        ...
        <div className="flex items-center justify-end relative h-full w-full py-10">
           <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-[#0b0e1a]/70 backdrop-blur-3xl border border-blue-500/30 rounded-3xl p-8 md:p-10 lg:p-12 w-full max-w-md shadow-[0_30px_60px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.1)] relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl lg:text-4xl font-bold text-white mb-10 font-heading leading-tight">
                  {currentStep.title}
                </h3>
                ...
                <p className="text-white/70 text-base lg:text-lg leading-relaxed mb-12 min-h-[80px]">
                  {currentStep.desc}
                </p>
