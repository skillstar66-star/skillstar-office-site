...
const aiFeatures = [
  {
    title: 'AI Chatbots',
    desc: 'Intelligent chatbots designed to handle customer questions, provide instant responses, and support users around the clock while reducing repetitive customer support tasks.',
    icon: Bot,
    color: 'from-[#00C6FF] to-[#3B82F6]',
    gradientBg: 'from-[#051842]/70 to-[#020516]/90',
    tags: ['24/7 Automated Support', 'Natural Language Processing', 'Instant Resolution', 'Multi-Channel']
  },
  {
    title: 'Virtual Assistants',
    desc: 'AI-powered assistants that help users access information, complete routine tasks, and interact with digital services through simple and natural conversations.',
    icon: Sparkles,
    color: 'from-[#3B82F6] to-[#8B5CF6]',
    gradientBg: 'from-[#1E0F45]/70 to-[#020516]/90',
    tags: ['Conversational AI', 'Voice & Text', 'Personalized Assistance', 'Task Automation']
  },
  {
    title: 'Workflow Automation',
    desc: 'Automated workflows that reduce manual processes by connecting repetitive tasks and business operations, helping teams save time and improve productivity.',
    icon: Zap,
    color: 'from-[#8B5CF6] to-[#D946EF]',
    gradientBg: 'from-[#2D0B4E]/70 to-[#020516]/90',
    tags: ['Process Streamlining', 'API Webhooks', 'Error Elimination', 'High Efficiency']
  },
  {
    title: 'CRM Integrations',
    desc: 'Seamless integration between AI solutions and CRM systems to organize customer information, automate processes, and improve lead and customer management.',
    icon: Database,
    color: 'from-[#D946EF] to-[#EC4899]',
    gradientBg: 'from-[#3B0A42]/70 to-[#020516]/90',
    tags: ['HubSpot & Salesforce', 'Auto Lead Enrichment', 'Data Syncing', 'Pipeline Tracking']
  },
  {
    title: 'Predictive Analytics',
    desc: 'Data-driven insights that identify patterns, trends, and potential outcomes, helping businesses make more informed decisions and plan ahead with greater confidence.',
    icon: TrendingUp,
    color: 'from-[#00C6FF] to-[#8B5CF6]',
    gradientBg: 'from-[#0A1A45]/70 to-[#020516]/90',
    tags: ['Demand Forecasting', 'Churn Prediction', 'Customer Behavior', 'Data Intelligence']
  },
  {
    title: 'Custom AI Tools',
    desc: 'Tailored AI solutions built around specific business requirements, from intelligent data processing to specialized automation tools that solve unique operational challenges.',
    icon: Wrench,
    color: 'from-[#8B5CF6] to-[#00C6FF]',
    gradientBg: 'from-[#17104A]/70 to-[#020516]/90',
    tags: ['Custom LLM Fine-Tuning', 'Document Parsing', 'Proprietary Automation', 'Secure APIs']
  }
];
    ...
    <div className="bg-[#020516] min-h-screen text-white font-sans overflow-x-hidden selection:bg-[#8B5CF6] selection:text-white">
      ...
      <section className="pt-36 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="flex items-center gap-2 text-xs uppercase tracking-wider text-gray-400 mb-8">
            ...
            <span>/</span>
            <span className="text-[#00C6FF] font-semibold">AI & Intelligent Automation</span>
          </div>
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <span className="text-xs uppercase font-bold tracking-widest text-gray-300">Next-Gen Business Intelligence & Automation</span>
            </motion.div>
            ...
            >
              Smart technology can reduce repetitive work, improve customer interactions, and help businesses make faster, better decisions. <strong className="text-white font-semibold">Skillstar Digital Solutions</strong> provides AI and intelligent automation solutions that connect technology with everyday business needs, helping streamline operations, improve efficiency, and create more scalable digital workflows.
            </motion.p>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl sm:text-4xl font-display font-extrabold text-white mb-4 tracking-tight">
              Enterprise AI & Automation Capabilities
            </h2>
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
              We connect custom AI models, chatbots, automated data flows, and intelligent analytics to transform operational productivity.
            </p>
          </div>
      ...
      <section className="py-20 bg-[#020516] relative overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-[#0A0F24]/90 via-[#0E1538]/80 to-[#120B24]/90 border border-white/15 backdrop-blur-xl shadow-2xl relative overflow-hidden">
            ...
            <div className="grid lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-gray-200">24/7 Automated Customer Support</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-[#8B5CF6] flex-shrink-0" />
                    <span className="text-sm font-medium text-gray-200">90% Reduction in Manual Data Entry</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-[#D946EF] flex-shrink-0" />
                    <span className="text-sm font-medium text-gray-200">Seamless Integration with Existing Tools</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-[#00C6FF] flex-shrink-0" />
                    <span className="text-sm font-medium text-gray-200">Bank-Grade Data Privacy & Security</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-4 flex flex-col items-center justify-center p-6 rounded-2xl bg-[#050A1A]/80 border border-white/10 text-center">
                <Network className="w-12 h-12 text-[#00C6FF] mb-3 animate-pulse" />
                <h4 className="text-lg font-bold text-white mb-2">Ready to Integrate AI?</h4>
                <p className="text-xs text-gray-400 mb-5 leading-relaxed">
                  Let's explore your business workflows and build tailored automation blueprints.
                </p>
                <Link
                  to="/#contact"
...
export default AiIntelligentAutomation;
